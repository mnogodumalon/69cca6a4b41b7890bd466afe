...
export function MitarbeiterverwaltungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: MitarbeiterverwaltungDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'mitarbeiterverwaltung');
    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="mitarbeiter_email">E-Mail</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="mitarbeiter_telefon">Telefon</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="rolle">Rolle / Abteilung</Label>
            <Input
              id="rolle"
              value={fields.rolle ?? ''}
              onChange={e => setFields(f => ({ ...f, rolle: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="notizen_mitarbeiter">Notizen</Label>
            <Textarea
              id="notizen_mitarbeiter"
              value={fields.notizen_mitarbeiter ?? ''}
              onChange={e => setFields(f => ({ ...f, notizen_mitarbeiter: e.target.value }))}
              rows={3}
            />
          </div>
          <DialogFooter>
