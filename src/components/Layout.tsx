...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconReceipt, IconSettings, IconUsers } from '@tabler/icons-react';
...
const APP_TITLE = 'Rechnungsverwaltung Beratung';
...
const navigation = [
  ...
  { name: 'Kundenverwaltung', href: '/kundenverwaltung', icon: IconUsers },
  { name: 'Mitarbeiterverwaltung', href: '/mitarbeiterverwaltung', icon: IconUsers },
  { name: 'Leistungskatalog', href: '/leistungskatalog', icon: IconFileText },
  { name: 'Rechnungsverwaltung', href: '/rechnungsverwaltung', icon: IconReceipt },
];

const externalNavigation = [
  { name: 'Kundenverwaltung', href: '/gateway/apps/69cca67904d6dcbf70bd3438?template=list_page', icon: IconUsers },
  { name: 'Mitarbeiterverwaltung', href: '/gateway/apps/69cca67d1dda0328fd80587c?template=list_page', icon: IconUsers },
  { name: 'Leistungskatalog', href: '/gateway/apps/69cca67d98bb6b40fd543485?template=list_page', icon: IconFileText },
  { name: 'Rechnungsverwaltung', href: '/gateway/apps/69cca67df510d6410e12a8f1?template=list_page', icon: IconReceipt },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69cca67904d6dcbf70bd3438?template=list_page"
