...
const RECHNUNGSVERWALTUNG_FIELDS = [
  ...
  { key: 'kunde_ref', label: 'Kunde', type: 'applookup/select', targetEntity: 'kundenverwaltung', targetAppId: 'KUNDENVERWALTUNG', displayField: 'kundennummer' },
  { key: 'mitarbeiter_ref', label: 'Zuständiger Mitarbeitender', type: 'applookup/select', targetEntity: 'mitarbeiterverwaltung', targetAppId: 'MITARBEITERVERWALTUNG', displayField: 'mitarbeiter_vorname' },
  { key: 'leistungen_ref', label: 'Leistung', type: 'applookup/select', targetEntity: 'leistungskatalog', targetAppId: 'LEISTUNGSKATALOG', displayField: 'leistungsbezeichnung' },
  { key: 'menge', label: 'Menge / Stunden', type: 'number' },
  { key: 'nettobetrag', label: 'Nettobetrag (€)', type: 'number' },
  { key: 'steuersatz_rechnung', label: 'Steuersatz', type: 'lookup/select', options: [{ key: 'steuersatz_19', label: '19%' }, { key: 'steuersatz_7', label: '7%' }, { key: 'steuersatz_0', label: '0%' }] },
  { key: 'bruttobetrag', label: 'Bruttobetrag (€)', type: 'number' },
  { key: 'zahlungsdatum', label: 'Zahlungseingangsdatum', type: 'date/date' },
  { key: 'zahlungsart', label: 'Zahlungsart', type: 'lookup/select', options: [{ key: 'ueberweisung', label: 'Überweisung' }, { key: 'lastschrift', label: 'Lastschrift' }, { key: 'kreditkarte', label: 'Kreditkarte' }, { key: 'bar', label: 'Bar' }, { key: 'paypal', label: 'PayPal' }] },
  { key: 'rechnungsdokument', label: 'Rechnungsdokument (PDF)', type: 'file' },
  { key: 'notizen_rechnung', label: 'Notizen', type: 'string/textarea' },
];
const LEISTUNGSKATALOG_FIELDS = [
  ...
  { key: 'einheit', label: 'Einheit', type: 'lookup/select', options: [{ key: 'stunde', label: 'Stunde' }, { key: 'tag', label: 'Tag' }, { key: 'pauschal', label: 'Pauschal' }, { key: 'woche', label: 'Woche' }, { key: 'monat', label: 'Monat' }] },
  { key: 'standardpreis', label: 'Standardpreis (€)', type: 'number' },
  { key: 'steuersatz_leistung', label: 'Steuersatz', type: 'lookup/select', options: [{ key: 'steuersatz_19', label: '19%' }, { key: 'steuersatz_7', label: '7%' }, { key: 'steuersatz_0', label: '0%' }] },
...
const MITARBEITERVERWALTUNG_FIELDS = [
  ...
  { key: 'mitarbeiter_email', label: 'E-Mail', type: 'string/email' },
  { key: 'mitarbeiter_telefon', label: 'Telefon', type: 'string/tel' },
  { key: 'rolle', label: 'Rolle / Abteilung', type: 'string/text' },
  { key: 'stundensatz', label: 'Stundensatz (€)', type: 'number' },
  { key: 'eintrittsdatum', label: 'Eintrittsdatum', type: 'date/date' },
  { key: 'notizen_mitarbeiter', label: 'Notizen', type: 'string/textarea' },
];
