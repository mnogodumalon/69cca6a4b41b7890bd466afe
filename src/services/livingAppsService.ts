...
import type { Rechnungsverwaltung, Leistungskatalog, Mitarbeiterverwaltung, Kundenverwaltung, CreateRechnungsverwaltung, CreateLeistungskatalog, CreateMitarbeiterverwaltung, CreateKundenverwaltung } from '@/types/app';
