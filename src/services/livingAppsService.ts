...
import type { Kundenverwaltung, Mitarbeiterverwaltung, Leistungskatalog, Rechnungsverwaltung, CreateKundenverwaltung, CreateMitarbeiterverwaltung, CreateLeistungskatalog, CreateRechnungsverwaltung } from '@/types/app';
